...
Suchfelder werden paarweise untereindander angezeigt.
...
[OBJECT\_CLASS](#objectclass-klasse "wikilink")
...
[Syntax von WollMux-Config-Dateien](Format_von_WollMux-Config-Dateien.md "wikilink").
...
[Schluessel-Abschnitt bei LDAP-Datenquellen](#schluessel-definition "wikilink").
...
im [Format von WollMux-Config-Dateien](Format_von_WollMux-Config-Dateien.md "wikilink").
...
[hier](Datenquellensammlung.md "wikilink").
...
Sie ist in
[URL-Notation](Format_von_WollMux-Config-Dateien.md#urls "wikilink").
Relative URLs werden relativ zum
[DEFAULT\_CONTEXT](#der_defaultcontext "wikilink")
...
Datei entspricht der [Syntax der wollmux.conf](Format_von_WollMux-Config-Dateien.md "wikilink") und ihre
...
[WollMux-Funktionen](#funktionen "wikilink")
...
sich nach dem unter
[Menue-Elemente](#menue-elemente "wikilink")
...
das Menü vom [Menü-Manager](WollMuxBar.md#menü-manager "wikilink") als
...
- *openExt*: Öffnet eine Datei oder URL mit einer externen Anwendung.
    ...
    Abschnitt
    [ExterneAnwendungen](#externeanwendungen "wikilink")
    erforderlich.
...
-   *menuManager*: Ruft den
    [Menü-Manager](WollMuxBar#menü-Manager "wikilink") auf. Mit
...
-   *options*: Ruft den
    ...
    [Fensterverhalten](#wollmuxbar-fenster "wikilink")
...
[Textfragmente-Abschnitt](#textfragmente "wikilink")
...
enthaltenen
[Dokumentkommandos](Dokumentkommandos_des_WollMux.md "wikilink") aus.
Enthält die Vorlage das Dokumentkommando
[insertContent](Dokumentkommandos_des_WollMux.md#das-kommando-insertcontent "wikilink"),
...
bzw. über den [Optionen-Dialog](WollMuxBar.md#optionen-dialog "wikilink")
aktiviert.
...
der Benutzer im [Optionen-Dialog](WollMuxBar.md#optionen-dialog "wikilink")
...
- Der Unterabschnitt Labels kann über den
    [Menü-Manager](WollMuxBar.md#menü-manager "wikilink")
    bearbeitet werden.
...
- Die aktiven CONF\_IDs können über den
    [Optionen-Dialog](WollMuxBar.md#optionen-dialog "wikilink")
    ausgewählt werden.
...
[gleichnamige Attribut des "Textdokumente"-Abschnitts](#zoom-zoomwert "wikilink").
...
**[Stringverarbeitung](#stringverarbeitung "wikilink")**

- [String](#string "wikilink") - ein
    String-Literal ist die einfachste Grundfunktion.
- [LENGTH](#length-argument1--argumentn "wikilink") -
    liefert die Länge (in Zeichen) eines Strings.
- [MATCH](#match-argument-regex "wikilink") -
    testet, ob ein String einem durch einen regulären Ausdruck gegebenen
    Muster entspricht.
- [REPLACE](#replace-argument-regex-repstr "wikilink") -
    ersetzt Teile eines Strings mit Hilfe von regulären Ausdrücken.
- [SPLIT](#split-argument-regex-index "wikilink") -
    Teile Strings mit Hilfe von regulären Ausdrücken auf in mehrere
    Teile und liefere einen dieser Teile zurück.
- [CAT](#cat-argument1--argumentn "wikilink") -
    verkettet mehrere Strings zu einem langen String.
- [FORMAT](#formatargument-min-minstellen-max-maxstellen "wikilink") -
    formatiert Zahlenwerte auf eine minimale und/oder maximale Anzahl
    von Nachkommastellen.

**[Arithmetik](#arithmetik "wikilink")**

- [SUM](sum-argument1--argumentn "wikilink") -
    bildet die Summe aus einer Reihe von Zahlenwerten.
- [DIFF](#diff-argument1--argumentn "wikilink") -
    subtrahiert von einem Zahlenwert einen oder mehrere
    andere Zahlenwerte.
- [PRODUCT](#product-argument1--argumentn "wikilink") -
    bildet das Produkt aus einer Reihe von Zahlenwerten.
- [DIVIDE](#dividedividend-bydivisor-min-minstellen-max-maxstellen "wikilink") -
    berechnet den Quotienten aus 2 Zahlenwerten mit beliebig
    vorgebbarer Genauigkeit.
- [ABS](#abs-argument1--argumentn "wikilink") -
    berechnet den absoluten Betrag eines Zahlenwerts.
- [SIGN](#sign-argument1--argumentn "wikilink") -
    liefert -1, 0, +1 je nachdem, ob das Argument negativ, 0 oder
    positiv ist.

**[Vergleiche](#vergleiche "wikilink")**

- [ISERROR](#iserror-funktion "wikilink") -
    testet, ob eine Funktion einen Fehler zurückliefert.
- [ISERRORSTRING](#iserrorstring-funktion "wikilink") -
    vergleicht einen String mit dem speziellen Fehler-String.
- [STRCMP](#strcmp-argument1--argumentn "wikilink") -
    vergleicht 2 oder mehr Strings.
- [NUMCMP](#numcmp-argument1--argumentn-margin-maxabweichung- "wikilink") -
    vergleicht 2 oder mehr Zahlenwerte.
- [LT](#lt-argument1--argumentn-margin-maxabweichung- "wikilink") -
    prüft, ob zwischen der ersten Zahl und den folgenden Zahlen die &lt; Beziehung besteht.
- [LE](#le-argument1--argumentn-margin-maxabweichung- "wikilink") -
    prüft, ob zwischen der ersten Zahl und den folgenden Zahlen die &lt;= Beziehung besteht.
- [GT](#gt-argument1--argumentn-margin-maxabweichung- "wikilink") -
    prüft, ob zwischen der ersten Zahl und den folgenden Zahlen die &gt; Beziehung besteht.
- [GE](#ge-argument1--argumentn-margin-maxabweichung- "wikilink") -
    prüft, ob zwischen der ersten Zahl und den folgenden Zahlen die &gt;= Beziehung besteht.

**[Logische Verknüpfungen](#logische-verknüpfungen "wikilink")**

- [AND](#and-funktion1--funktionn "wikilink") -
    liefert "true" gdw. alle enthaltenen Funktionen "true" liefern.
- [OR](#or-funktion1--funktionn "wikilink") -
    liefert "true" gdw. mindestens eine der enthaltenen Funktionen
    "true" liefert.
- [NOT](#not-funktion1--funktionn "wikilink") -
    liefert "true" gdw. keine der enthaltenen Funktionen "true" liefert.

**[Ablaufsteuerung/Kontrollfluss](#ablaufsteuerungkontrollfluss "wikilink")**

- [IF](#if-bedingung-then-dann-else-sonst- "wikilink") -
    testet eine Bedingung und liefert bei "true" den THEN-Teil, bei
    "false" den ELSE-Teil als Ergebnis.
- [SELECT](#select-funktion1--funktionn "wikilink") -
    wählt aus einer Reihe von Funktionen einen Wert aus, typischerweise
    abhängig von Bedingungen.

**[Funktionen für Formulare](#funktionen-für-formulare "wikilink")**

- [VALUE](#value-argument "wikilink") -
    liefert den Wert eines Formularfeldes.
- [DIALOG](#dialog-dialogname-feldname "wikilink") -
    liefert einen über einen Funktionsdialog ausgewählten Wert.

**[Zugriff auf externe Funktionen](#zugriff-auf-externe-funktionen "wikilink")**

- [EXTERN](#extern-url-url-paramsparam1--paramn "wikilink") -
    ermöglicht den Zugriff auf externe Java oder Basic-Funktionen.
- [BIND (mit Funktionsname)](#bind-function-funktionsname-setparamname1-wert1--setparamnamen-wertn "wikilink") -
    ruft eine global im Funktionen-Abschnitt definierte externe Funktion mit Parametern auf.
- [BIND (mit Funktion)](#bind-functionfunktion-setparamname1-wert1--setparamnamen-wertn "wikilink") -
...
[Funktionsdialoge](#funktionsdialoge "wikilink")
definiert wurde.
...
Und das zugehörige
[WollMux-Dokumentkommando](#trafo-funktionsbezeichner "wikilink")

`WM(CMD 'insertFormValue' ID 'Anrede' TRAFO 'derDie')`

### BIND (FUNCTION(&lt;Funktion&gt;) SET("&lt;ParamName1&gt;" &lt;Wert1&gt;) ... SET("&lt;ParamNameN&gt;" &lt;WertN&gt;))

Wie [BIND mit Angabe eines Funktionsnames hinter FUNCTION](#bind-function-funktionsname-setparamname1-wert1--setparamnamen-wertn "wikilink"),
jedoch wird hier als &lt;Funktion&gt; eine komplette WollMux-Funktion direkt
angegeben, typischerweise eine
[EXTERN-Funktion](#extern-url-url-paramsparam1--paramn "wikilink").
...
entspricht der [bereits weiter oben beschriebenen](#beschreibung-eingabefeld-1 "wikilink").
...
[Funktionen](#funktionen "wikilink") aus
...
unter: [Schnittstellen für Experten: Einbinden von Komfortdruckfunktionen](Schnittstellen_des_WollMux_fuer_Experten.md#einbinden-eigener-komfortdruckfunktionen "wikilink").
...
- Bei Verwendung von
    [wollmux:Open](Schnittstellen_des_WollMux_fuer_Experten.md#wollmuxopen "wikilink")
...
- In der [Syntax der wollmux.conf](Format_von_WollMux-Config-Dateien.md "wikilink") bedeuten
...
gleichnamige Attribut bei Buttons mit [ACTION "openExt"](#das-attribut-action "wikilink")
...
- Nach dem Start einer externen Anwendung schließt der WollMux
    ...
    Verhalten Probleme haben, kann entweder das [Attribut PIPE "true"](#pipe-trueoderfalse "wikilink")
...
die externe Anwendung über die [ACTION "closeAndOpenExt" oder "saveTempAndOpenExt"](Dokumentkommandos_des_WollMux.md#action-aktion "wikilink"),
...
Die Attribute \*\_HIGHLIGHT\_COLOR "&lt;farbe&gt;": Über die Attribute \*\_HIGHLIGHT\_COLOR können Hintergrundfarben vergeben werden, mit denen die [Blöcke zur Drucksteuerung](Hilfen_fuer_Sachleitende_Verfuegungen_verwenden.md#die-schaltflächen-zur-drucksteuerung-einzelner-blöcke "wikilink") der Sachleitenden Verfügungen hinterlegt werden können, um sie optisch abzuheben und damit leichter orten zu können. Die Farbe &lt;farbe&gt; wird als Hex-Zahl in der Form AARRGGBB (A=Alpha, R=Rot, G=Grün, B=Blau) beschrieben (z.B. entspricht "00ff0000" der Farbe rot). Führende Nullen können dabei weggelassen werden - so kann die vorherige Beispielzahl auch als "ff0000" beschrieben werden. Um den Druckblock ohne farbliche Markierung erscheinen zu lassen, ist der Wert **"none"** zu verwenden. Der vordere Teil des Attributnamens (z.B. ALL\_VERSIONS) ist analog zu den Namen der entsprechenden [Dokumentkommandos](Hilfen_fuer_Sachleitende_Verfuegungen_verwenden.md# "wikilink") benannt. Beim Drucken der Sachleitenden Verfügungen werden die in \*\_HIGHLIGHT\_COLOR gesetzten Farben **nicht** mit ausgedruckt.
...
I.". Wird nun z.B. über die Schaltfläche [Block: immer drucken](Hilfen_fuer_Sachleitende_Verfuegungen_verwenden.md#schaltfläche-immer-drucken "wikilink")
ein Block "immer Drucken" (repräsentiert durch das [Dokumentkommando allVersions](Dokumentkommandos_des_WollMux.md#das-kommando-allversions "wikilink"))
...
[WollMux-Funktionen](#arithmetik "wikilink")
...
[Konfigurationsdatei
*wollmuxbar.conf*](WollMuxBar#Konfiguration "wikilink") beim Starten der
...
[Aktionen](#das-attribut-action "wikilink") "menuManager" und "options"
nicht in der WollMuxBar angezeigt, d.h. die Funktionen
[Menümanager](WollMuxBar#menü-manager "wikilink") und
[Optionen-Dialog](WollMuxBar#optionen-dialog "wikilink") stehen in
...
[Menümanager](WollMuxBar#menü-manager "wikilink") in der WollMuxBar
angezeigt werden darf. Ist die Option deaktiviert, werden die Buttons
mit den [Aktionen](#das-attribut-action "wikilink") "menuManager" und
...
[--mm](WollMuxBar#-mm "wikilink") oder folgende Zeile in der
...
beim Debugging und ist auf der Seite [Wollmux-Debugging - Einstellungen\_in\_der\_wollmux.conf](Wollmux-Debugging.md#verwendung "wikilink")
...
Im Abschnitt *FormularMax4000* können Einstellungen zum [FormularMax 4000](FormularMax_4000.md "wikilink") getätigt werden.
...
Formular-GUI-Beschreibung findet sich unter [Dokumentkommandos des WollMux](okumentkommandos_des_WollMux.md#beschreibung-der-formular-gui "wikilink")):
